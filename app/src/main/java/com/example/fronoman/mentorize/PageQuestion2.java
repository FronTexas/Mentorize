 ...
 */
public class PageQuestion2 extends Fragment implements CardQuestion.OnQuestionAnswered {
    ...
    private String[] question = new String[]{"Do you want to be a mentor?", "Which of the following is most applicable to you?"};
    private int[] isAgreensss = new int[]{0, 1};
    CardQuestion[] cqs;
    ...
    public void onQuestionAnswered(String answer) {
        if (questionCounter < question.length - 1) {
            ...
            ((MainActivity) getActivity()).replaceFragments(this, new PageQuestion(), true, "");
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        for (int i = 0; i < cqs.length; i++) {
            ...
            if (isAgreensss[i] == 1) {
                cqs[i].agreeness = new String[]{"Ex-Convict", "Depression", "Alcoholism"};
                cqs[i].changeAgreeness();
            }
        }
